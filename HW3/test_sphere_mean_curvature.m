clear; close all; clc;
file_names = dir(fullfile('hw2_data/cat*.off'));
for k = 1:length(file_names)
  ...
  curvature = calc_mean_curvature(vertex, face);
  ...
  save_png_file = fullfile('pngs', sprintf('%s_mean_curvature.png', base_file_name(1:end-4)));
  saveas(gcf, save_png_file);
  save_fig_file = fullfile('figs', sprintf('%s_mean_curvature.fig', base_file_name(1:end-4)));
