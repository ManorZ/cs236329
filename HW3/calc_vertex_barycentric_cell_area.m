function vertex_area = calc_vertex_barycentric_cell_area(vertex, face)
%   vertex_area = calc_vertex_barycentric_cell_area(vertex, face)
%   Calculate each vertex barycentric cell area based on the sum of the neighboring faces
%   areas divided by 3.
